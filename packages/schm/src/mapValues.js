// @flow
import { toArray, isSchema } from './utils'
...
const mapValues: MapValuesFunction = (values, params, transformValueFn, paramNames = []) => (
  Object.keys(params).reduce((finalParams, paramName) => {
    ...
    const mergeParam = finalValue => ({ ...finalParams, [paramName]: finalValue })
